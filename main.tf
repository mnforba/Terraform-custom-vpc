...
# Creat an internet gateway named "tutorial_igw"
...
# Create the EC2 instance named "tutorial_web"
resource "aws_instance" "tutorial_web" {
    ...
    # We are tagging the EC2 instance with the name "tutorial_db_" followe by
    # the count index
    tags = {
